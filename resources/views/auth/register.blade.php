...
<body class="hold-transition register-page" style="background-image: url('{{asset('images/background.png')}}'); background-size: cover">
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <a href="{{ url('/login') }}" class="text-center">Já sou cadastrado</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
