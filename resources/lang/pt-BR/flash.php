...
return [
    ...
    'not_saved'                => '[m] não foi possível de ser criado.                                 |[f] não foi possível de ser criada',
    'not_updated'              => '[m] não foi possível ser alterado.                                 |[f] não foi possível de ser criada',
    ...
    'duplicate_foreign_key'    => '[m] Atenção! O CPF deve ser único para cada usuário.',
